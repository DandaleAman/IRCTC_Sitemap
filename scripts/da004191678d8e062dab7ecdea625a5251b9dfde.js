try {
    window.izConfig = {
        ...
        "isSdkHttps": 1,
        "locale": "en",
        "sourceOrigin": "https://www.irctc.co.in",
        "vapidPublicKey": "BOgcAqTXxChH8Z4nJ9FP4saJ_E1sDvOaLRnYSbQkhvnAzraAgIBBRF-vKNFjVOPNNIj0ryDUJW00Lvi99q3FjEU",
        "promptDelay": 0,
        "client": 50238,
        "domainRoot": "/nget",
        "webServiceUrl": "",
        "serviceWorkerName": "/ngsw-worker.js",
        "debug": 0,
        "setEnr": 1,
    ...
    if ("" !== izConfig.customPixelLink) {
        ...
        _izAlt.id = "izootoAlt", _izAlt.src = izConfig.customPixelLink, container.appendChild(_izAlt)
    } else {
        var _iz = document.createElement("script");
        _iz.id = "izootoSdk", _iz.src = "https://cdn.izooto.com/scripts/sdk/izooto.js", container.appendChild(_iz)
    }
} catch (err) {}