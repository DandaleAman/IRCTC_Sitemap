/*! @name videojs-contrib-ads @version 7.5.2 @license Apache-2.0 */ ! function(e, t) {
    ...
    var r = function(e, t) {
        ...
        s = function(e, t) {
            e.ads.isInAdMode() ? e.ads.isContentResuming() ? (r(0, t), e.trigger("resumeended")) : o(e, "ad", t) : e.ads._contentHasEnded || e.ads.stitchedAds() || (o(e, "content", t), e.trigger("readyforpostroll"))
        },
        A = function(e, t) {
    ...
    var f = {},
            ...
            ! function(n) {
                if (e.dom.isInFrame() && "function" != typeof t.__tcfapi) {
                    ...
                    t.__tcfapi = function(e, t, n, r) {
                        ...
                        n && "function" == typeof o[n.callId] && (o[n.callId](n.returnValue, n.success), o[n.callId] = null)
                    }, !1)
                }
        ...
        g = "",
        y = function(e, n) {
            if (void 0 === n && (n = t), n.__uspapi) n.__uspapi("getUSPData", 1, function(t, n) {
                ...
                var a = function(e) {
                    for (var t = e.parent; t !== e.top;) {
                        try {
                            if (t.frames && t.frames.__uspapiLocator) return t
                        } catch (e) {}
                        t = t.parent
                    }
                    try {
                        if (e.top.frames && e.top.frames.__uspapiLocator) return e.top
                    } catch (e) {}
                    return null
                }(n);
        ...
        b = function(e, t) {
            ...
            return ["description", "tags", "reference_id", "ad_keys"].forEach(function(a) {
                ...
                ! function(e, t, n) {
                    if (e && e[n])
                        for (var a = e[n], r = Object.keys(a), o = 0; o < r.length; o++) t["{mediainfo." + n + "." + r[o] + "}"] = a[r[o]]
                }(e, n, t)
            }), n
        },
        S = function(e) {
        ...
        k = function(e) {
            ...
            return Object.keys(e).forEach(function(n) {
                t["{tcf." + n + "}"] = e[n]
            }), t["{tcf.gdprAppliesInt}"] = e.gdprApplies ? 1 : 0, t
        },
        B = function() {
            return {
                "{usp.uspString}": g
        ...
        _ = function(n, a, r) {
            ...
            if (s) return s.forEach(function(n) {
                for (var r, o = n, s = n.slice(14, -1), A = s.split("."), d = t, l = 0; l < A.length; l++)
                    if (l === A.length - 1) r = d[A[l]];
                    else if (void 0 === (d = d[A[l]])) break;
                var u = typeof r;
                null === r ? i[o] = "null" : void 0 === r ? a[o] ? i[o] = a[o] : (e.log.warn('Page variable "' + s + '" not found'), i[o] = "") : "string" !== u && "number" !== u && "boolean" !== u ? (e.log.warn('Page variable "' + s + '" is not a supported type'), i[o] = "") : i[o] = r
            }), i
        },
        C = function(t, n, a, r, o) {
            for (var i in void 0 === r && (r = {}), n) {
                var s = r.hasOwnProperty(i) ? r[i] : i;
                if (s.startsWith("r:")) try {
    ...
    R.processAdTrack = function(t, n, a, r) {
        ...
        for (var o = 0; o < n.length; o++) {
            ...
            var A = this.getCueId(t, i),
                d = i.startTime;
            if (T(t, A)) return void e.log("Skipping ad already seen with ID " + A);
            r && r(t, s, A, d), a(t, s, A, d), w(t, A)
        }
    };
    var L = {},
        E = e;
    L.isMiddlewareMediatorSupported = function() {
        ...
        return {
            ...
            callPlay: function() {
                if (t.ads && !0 === t.ads._shouldBlockPlay) return t.ads.debug("Using playMiddleware to block content playback"), t.ads._playBlocked = !0, E.middleware.TERMINATOR
            },
            play: function(n, a) {
    ...
    var O = {
        ...
        Z = function() {
            ...
            return n.transitionTo = function(e) {
                ...
                for (var a = arguments.length, r = new Array(a > 1 ? a - 1 : 0), o = 1; o < a; o++) r[o - 1] = arguments[o];
            ...
            }, n.onAdsError = function() {}, n.onAdsCanceled = function() {}, n.onAdTimeout = function() {}, n.onAdStarted = function() {}, n.onAdSkipped = function() {}, n.onContentChanged = function() {}, n.onContentResumed = function() {}, n.onReadyForPostroll = function() {
    ...
    var H = {
            start: function(t) {
                t.ads.debug("Starting ad break"), t.ads._inLinearAdMode = !0, t.trigger("adstart"), t.ads.shouldTakeSnapshots() && (t.ads.snapshot = function(t) {
                    ...
                    return i.suppressedTracks = o, i
                }(t)), t.ads.shouldPlayContentBehindAd(t) && !t.ads.settings.stitchedAds && (t.ads.preAdVolume_ = t.volume(), t.volume(0)), t.addClass("vjs-ad-playing"), t.hasClass("vjs-live") && t.removeClass("vjs-live"), t.ads.removeNativePoster(), t.ads.preAdPlaybackRate_ = t.playbackRate(), t.playbackRate(1), t.controlBar && t.controlBar.playbackRateMenuButton && t.controlBar.playbackRateMenuButton.playbackRateSupported && !t.controlBar.playbackRateMenuButton.hasClass("vjs-hidden") ? (t.controlBar.playbackRateMenuButton.hide(), t.ads.showPlaybackMenuOnAdEnd_ = !0) : t.ads.showPlaybackMenuOnAdEnd_ = !1
            },
            end: function(t, n) {
                t.ads.debug("Ending ad break"), void 0 === n && (n = function() {}), t.ads.adType = null, t.ads._inLinearAdMode = !1, t.trigger("adend"), t.removeClass("vjs-ad-playing"), t.ads.isLive(t) && t.addClass("vjs-live"), t.ads.shouldTakeSnapshots() ? function(t, n) {
                    ...
                    var r, o = t.$(".vjs-tech"),
                        ...
                        A = function() {
                            for (var e = 0; e < s.length; e++)(r = s[e]).track.mode = r.mode
                        },
                        d = function() {
                            var n;
                        ...
                        l = function n() {
                            if (t.off("contentcanplay", n), G && t.clearTimeout(G), (o = t.el().querySelector(".vjs-tech")).readyState > 1) return d();
                            if (void 0 === o.seekable) return d();
                            if (o.seekable.length > 0) return d();
                    ...
                    if ("style" in a && o.setAttribute("style", a.style || ""), t.ads.videoElementRecycled()) t.one("resumeended", function() {
                        delete t.ads.snapshot, n()
                    }), t.one("contentloadedmetadata", A), e.browser.IS_IOS && !t.autoplay() && "function" == typeof t.techCall_ && (t.techCall_("setAutoplay", !0), t.ads.shouldRemoveAutoplay_ = !0), t.src(a.sources), t.one("contentcanplay", l), G = t.setTimeout(l, 2e3);
                    else {
                        if (A(), !t.ended()) {
                            var u = t.play();
                ...
                }(t, n) : (t.ads.preAdVolume_ && t.volume(t.ads.preAdVolume_), n()), t.playbackRate(t.ads.preAdPlaybackRate_), t.ads.showPlaybackMenuOnAdEnd_ && t.controlBar.playbackRateMenuButton.show()
            }
        },
        Y = function(t) {
            function n() {
            ...
            return a.init = function(e, t, n) {
                ...
                var n = this;
                e.log("adserror (Preroll)"), t.ads.error({
                ...
                var t = this.player;
                !this.adsReady || t.ads.inAdBreak() || this.isContentResuming() ? e.log.warn("Unexpected startLinearAdMode invocation (Preroll)") : (this.clearTimeout(t), t.ads.adType = "preroll", this.waitingForAdBreak = !1, H.start(t), t.ads._shouldBlockPlay = !1)
            }, a.onAdStarted = function(e) {
                e.removeClass("vjs-ad-loading")
            }, a.endLinearAdMode = function() {
                var e = this.player;
                this.inAdBreak() && (e.removeClass("vjs-ad-loading"), e.addClass("vjs-ad-content-resuming"), this.contentResuming = !0, H.end(e))
    ...
    var Q = function(e) {
        ...
        return n.init = function(e) {
            ...
            this.player.ads.debug("adserror (BeforePreroll)"), this.player.ads.error({
    ...
    var V = function(e) {
        ...
        var n = t.prototype;
        return n.init = function(e) {
            e.ads.adType = "midroll", H.start(e), e.addClass("vjs-ad-loading")
        }, n.onAdStarted = function(e) {
            e.removeClass("vjs-ad-loading")
        }, n.endLinearAdMode = function() {
            var e = this.player;
            this.inAdBreak() && (this.contentResuming = !0, e.addClass("vjs-ad-content-resuming"), e.removeClass("vjs-ad-loading"), H.end(e))
    ...
    var X = function(t) {
        ...
        return a.init = function(e) {
            ...
            var t = this.player;
            t.ads.inAdBreak() || this.isContentResuming() ? e.log.warn("Unexpected startLinearAdMode invocation (Postroll)") : (t.ads.adType = "postroll", t.clearTimeout(this._postrollTimeout), this.waitingForAdBreak = !1, H.start(t))
        }, a.onAdStarted = function(e) {
            e.removeClass("vjs-ad-loading")
        }, a.endLinearAdMode = function() {
            var e = this,
            ...
            this.inAdBreak() && (t.removeClass("vjs-ad-loading"), this.resumeContent(t), H.end(t, function() {
                e.transitionTo(n)
            }))
        }, a.skipLinearAdMode = function() {
            var t = this.player;
            ...
            e.ads.debug("Postroll abort (adserror)"), e.ads.error({
    ...
    var J = function(e) {
        ...
        var n = t.prototype;
        return n.init = function() {
            this.waitingForAdBreak = !1, this.contentResuming = !1, this.player.ads.adType = "stitched", H.start(this.player)
            ...
            H.end(this.player), this.transitionTo(e)
        }, t
    }(D.getState("AdState"));
    ...
    var q = function(e) {
        ...
        return n.init = function(e) {
            ...
            e.ads.debug("Received adsready event (OutstreamPending)"), this.adsReady = !0
        }, n.onAdsError = function() {
            this.player.ads.debug("adserror (OutstreamPending)"), this.adsReady = !1
        }, t
    }(D.getState("AdState"));
    ...
    var K = function(t) {
        ...
        return a.init = function(e, t) {
            e.addClass("vjs-ad-loading"), t ? this.handleAdsReady() : this.abort(e)
        }, a.onAdsReady = function(t) {
            t.ads.inAdBreak() ? e.log.warn("Unexpected adsready event (Preroll)") : (t.ads.debug("Received adsready event (Preroll)"), this.handleAdsReady())
        }, a.abort = function(e) {
            var t = D.getState("OutstreamDone");
            e.removeClass("vjs-ad-loading"), this.transitionTo(t)
        }, a.onAdStarted = function(e) {
            e.removeClass("vjs-ad-loading")
        }, a.handleAdsReady = function() {
            this.adsReady = !0, this.readyForOutstreamPlayback()
            ...
            t.ads._hasThereBeenALoadStartDuringPlayerLife || e.log.warn("Leaving OutstreamPlayback state before loadstart event can cause issues."), this.cleanupPartial(t)
        }, a.cleanupPartial = function(e) {
            e.removeClass("vjs-ad-loading"), e.removeClass("vjs-ad-content-resuming"), this.clearTimeout(e)
        }, a.clearTimeout = function(e) {
            e.clearTimeout(this._timeout), this._timeout = null
            ...
            var n = this;
            e.log("adserror (OutstreamPlayback)"), this.inAdBreak() ? t.ads.endLinearAdMode() : this.afterLoadStart(function() {
                n.abort(t)
            })
        }, a.onAdTimeout = function(e) {
            var t = this;
            this.afterLoadStart(function() {
                e.ads.debug("adtimeout (OutstreamPlayback)"), t.abort(e)
            })
        }, a.onAdsCanceled = function(e) {
            var t = this;
            e.ads.debug("adscanceled (OutstreamPlaybac)"), this.afterLoadStart(function() {
                t.abort(e)
            })
        }, a.endLinearAdMode = function() {
            var e = this;
            ...
            this.inAdBreak() ? e.log.warn("Unexpected skipLinearAdMode invocation") : this.afterLoadStart(function() {
                n.trigger("adskip"), n.ads.debug("skipLinearAdMode (OutstreamPlayback)"), t.transitionTo(a)
            })
        }, n
    }(D.getState("AdState"));
        ...
        ae = function(t) {
            ...
            te.concat(["firstplay", "loadedalldata"]).forEach(function(e) {
                    ...
                    return {
                        ...
                        error: function(n) {
                            if (void 0 === n) return this._error || null;
                            null !== n && n.errorType ? (this._error = n, e.log.error("An error with Ads occured. Type: " + n.errorType + "."), t.trigger({
                                type: "vjsadserror",
                                error: this._error
                            })) : this._error = null
                        }
                    }
                }(n), n.ads.settings = r, r.stitchedAds = !!r.stitchedAds, "outstream" === r.playerMode ? (n.src(O), n.ads._state = new(D.getState("OutstreamPending"))(n)) : r.stitchedAds ? n.ads._state = new(D.getState("StitchedContentPlayback"))(n) : n.ads._state = new(D.getState("BeforePreroll"))(n), n.ads._state.init(n), n.ads.cueTextTracks = R, n.ads.adMacroReplacement = function(e, t, n) {
                    void 0 === t && (t = !1), void 0 === n && (n = {});
                    var a = n.disableDefaultMacros || !1,
                        r = n.macroNameOverrides || {};
                    delete n.disableDefaultMacros, delete n.macroNameOverrides;
                    var o = n;
                    if (a) return C(e, o, t, r);
                    var i = S(e),
                        s = i.defaults,
                        A = i.modifiedString;
                    for (var d in e = A, u(o, P(this), b(this.mediainfo, s), k(f), B(), _(e, s, r)), e = C(e, o, t, r, this), s) e = e.replace(d, s[d]);
                    return e
                }.bind(n),
                function(e) {
            ...
            n.ready(function() {
                ...
                n.ads.reset(), n.textTracks().removeEventListener("change", i)
            }), h(), y(function() {}), n.ads.listenToTcf = h, n.ads.updateUsPrivacyString = function(e) {
                return y(e)
            }
        };
    return ae.Error = m, ae.VERSION = a,
        function(t) {
            !N(e) && ((e.registerPlugin || e.plugin)("ads", t), j() && !e.usingContribAdsMiddleware_ && (e.use("*", I), e.usingContribAdsMiddleware_ = !0, e.log.debug("Play middleware has been registered with videojs")))
        }(ae), ae
});