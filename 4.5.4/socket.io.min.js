...
! function(t, e) {
    ...
    for (var k = {
            ...
            var r, i = t.type,
                o = t.data;
            return w && o instanceof Blob ? e ? n(o) : O(o, n) : _ && (o instanceof ArrayBuffer || (r = o, "function" == typeof ArrayBuffer.isView ? ArrayBuffer.isView(r) : r && r.buffer instanceof ArrayBuffer)) ? e ? n(o) : O(new Blob([o]), n) : n(m[i] + (o || ""))
        }, O = function(t, e) {
                ...
                value: function() {
                    if (this.check()) {
                        var t = this.uri(),
                            ...
                            n = st ? {} : j(this.opts, "agent", "perMessageDeflate", "pfx", "key", "passphrase", "cert", "ca", "ciphers", "rejectUnauthorized", "localAddress", "protocolVersion", "origin", "maxPayload", "family", "checkServerIdentity");
    ...
    var lt = function(n) {
        ...
        function a(n) {
            ...
            }, o), r.opts.path = r.opts.path.replace(/\/$/, "") + "/", "string" == typeof r.opts.query && (r.opts.query = J(r.opts.query)), r.id = null, r.upgrades = null, r.pingInterval = null, r.pingTimeout = null, r.pingTimeoutTimer = null, "function" == typeof addEventListener && (r.opts.closeOnBeforeunload && (r.beforeunloadEventListener = function() {
    ...
    function gt(t) {
        ...
        }(t)) || yt && t instanceof Blob || vt && t instanceof File
    }
    ...
    function mt(e, n) {
        ...
        for (var o in e)
            if (Object.prototype.hasOwnProperty.call(e, o) && mt(e[o])) return !0;
        return !1
    }
    ...
    function bt(t) {
        var e = [],
            n = t.data,
            r = t;
        return r.data = kt(n, e), r.attachments = e.length, {
            packet: r,
            buffers: e
        }
    }
    ...
    function _t(e, n) {
        ...
        if (Array.isArray(e))
            ...
            for (var i in e) Object.prototype.hasOwnProperty.call(e, i) && (e[i] = _t(e[i], n));
        return e
    }
    var Et;
    ! function(t) {
            ...
            return r(a, [{
                ...
                value: function(t) {
                    ...
                    if ("string" == typeof t) {
                        ...
                        (e = this.decodeString(t)).type === Et.BINARY_EVENT || e.type === Et.BINARY_ACK ? (this.reconstructor = new Rt(e), 0 === e.attachments && y(s(a.prototype), "emitReserved", this).call(this, "decoded", e)) : y(s(a.prototype), "emitReserved", this).call(this, "decoded", e)
                    } else {
    ...
    var Bt = Object.freeze({
        ...
        St = function(t) {
            ...
            function i(t, r, o) {
                var s;
                return e(this, i), (s = n.call(this)).connected = !1, s.receiveBuffer = [], s.sendBuffer = [], s.ids = 0, s.acks = {}, s.flags = {}, s.io = t, s.nsp = r, o && o.auth && (s.auth = o.auth), s.io._autoConnect && s.open(), s
            }
            return r(i, [{
                key: "disconnected",
                get: function() {
    ...
    var xt = function(n) {
            ...
            function s(n, r) {
                var o, a;
                e(this, s), (o = i.call(this)).nsps = {}, o.subs = [], n && "object" === t(n) && (r = n, n = void 0), (r = r || {}).path = r.path || "/socket.io", o.opts = r, D(f(o), r), o.reconnection(!1 !== r.reconnection), o.reconnectionAttempts(r.reconnectionAttempts || 1 / 0), o.reconnectionDelay(r.reconnectionDelay || 1e3), o.reconnectionDelayMax(r.reconnectionDelayMax || 5e3), o.randomizationFactor(null !== (a = r.randomizationFactor) && void 0 !== a ? a : .5), o.backoff = new Nt({
